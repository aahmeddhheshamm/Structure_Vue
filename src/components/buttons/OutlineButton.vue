<template>
  <button
    class="relative rounded-md flex items-center justify-center gap-2 h-12 main-button border border-primary-700 text-primary-700 font-medium text-base leading-4 px-5 capitalize transition-all duration-500 text-nowrap"
  ...
  >
    <div
        v-if="loading"
        class="animate-spin inline-block size-4 border-[3px] border-current border-t-transparent text-primary-700 rounded-full"
        role="status"
        aria-label="loading"
    ></div>
